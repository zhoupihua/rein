...
7. **Write design doc** — save to `docs/rein/specs/YYYY-MM-DD-<name>-spec.md` and commit
...
**Documentation:**
- Write the validated design (spec) to `docs/rein/specs/YYYY-MM-DD-<name>-spec.md`
