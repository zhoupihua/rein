...
**Save output to:** `docs/rein/plans/YYYY-MM-DD-<name>-plan.md` + `docs/rein/tasks/YYYY-MM-DD-<name>-tasks.md`
...
**"Plan complete and saved to `docs/rein/plans/YYYY-MM-DD-<name>-plan.md` and `docs/rein/tasks/YYYY-MM-DD-<name>-tasks.md`. Two execution options:**
