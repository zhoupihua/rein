...
**The terminal state is invoking planning-and-task-breakdown.** Do NOT invoke any implementation skill. The ONLY skill you invoke after idea-refine is planning-and-task-breakdown.
