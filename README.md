...
| Hooks | 7 | session-start, guard, guard-bash, gate, format, leak-guard, inject |
...
| Hooks | Session injection only | 7 hooks (session-start, guard, guard-bash, gate, format, leak-guard, inject) |
