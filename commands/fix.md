...
5. Invoke `integration-testing` skill — regression check, ensure fix doesn't break related code
...
4. Invoke `verify` skill — verify all tests pass, build succeeds
5. Invoke `integration-testing` skill — coverage check, integration verification
6. Commit with `feat:` message
